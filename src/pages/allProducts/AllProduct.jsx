      ...
      <section className="md:py-10 bg-white">
        <div className="max-w-6xl mx-auto px-2 md:px-6">
          <div className="text-start mb-12">
            <h2 className="text-2xl md:text-4xl  font-extrabold text-gray-900 bg-[#EBD96B] inline px-2 py-1">
              ALL NEW ARRIVALS
            </h2>
            <p className="text-gray-60 dark:text-gray-500 font-semibold mt-2">
              Check out all the latest products
            </p>
          </div>
          {/* All products grid */}
              ...
              >
                ...
                <div className="flex justify-center">
                  <button
                    ...
                    disabled={isPending}
                    className="ml-2 mb-2 text-sm hover:bg-gray-800 bg-black text-white px-2 md:px-4 font-bold py-2 rounded cursor-pointer   transition"
                  >
