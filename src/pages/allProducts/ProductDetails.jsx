...
export default function ProductDetails() {
  ...
  return (
    <>
    <ScrollToTop/>
      <div className="max-w-6xl text-white mx-auto p-4 grid md:grid-cols-2 gap-8">
        {/* LEFT: Images */}
        <div>
          <div
            className="overflow-hidden rounded-lg border shadow-lg w-full"
        ...
        <div className="flex flex-col justify-between">
          <div>
            ...
            <div className="text-gray-700 dark:text-white font-medium space-y-1">
              <p>
            ...
            <div className="mt-4 ">
              <b>Description:</b>
              <p className="text-gray-600 dark:text-white mt-1 font-medium">
                {description}
              </p>
            </div>
